...
def get_batcher(src_file, dst_file, word2id, src_seq_length, dst_seq_length, batch_size, do_lower, substr_prefix='##',
                limit=None):
...
def get_predict_batcher(src_file, word2id, src_seq_length, batch_size, do_lower, substr_prefix='##', limit=None):
    src_tokens, src_ids, src_ids_extend, src_mask, src_oov_size, src_oovs = load_src(src_file=src_file,
                                                                                     seq_length=src_seq_length,
                                                                                     do_lower=do_lower,
                                                                                     vocab=word2id,
